...
namespace astator.Core.UI.Layout
{
    public class ScriptLinearLayout : LinearLayout, IScriptView
    {
        ...
        public new ScriptLinearLayout AddView(View child)
        {
            base.AddView(child);
            return this;
        }
                ...
                case "orientation":
                    {
                        ...
                        {
                            this.Orientation = Utils.EnumParse<Orientation>(value);
                        }
                        break;
                    }
                case "w":
        ...
        public object GetAttr(string key)
        {
            return key switch
            {
                ...
                "w" => new Func<object>(() =>
                {
                    ViewGroup.LayoutParams lp = new(this.LayoutParameters as MarginLayoutParams ?? new(ViewGroup.LayoutParams.MatchParent, ViewGroup.LayoutParams.MatchParent));
                    return lp.Width;
                }),
                "h" => new Func<object>(() =>
                {
