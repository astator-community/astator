...
{
    public class ScriptTextView : TextView
    {
        ...
        public ScriptTextView(Android.Content.Context context, UIArgs args) : base(context)
        {
                ...
                case "margin":
                    {
                        ...
                        else if (value is int[] arr)
                        {
                            if (arr.Length == 2)
                            {
                                margin[0] = margin[2] = Util.DpParse(arr[0]);
                                margin[1] = margin[3] = Util.DpParse(arr[1]);
                            }
