...
{
    public class ScriptRadioButton : RadioButton, IScriptView
    {
        ...
        public ScriptRadioButton(Android.Content.Context context, UiArgs args) : base(context)
        {
                ...
                case "checked":
                    {
                        if (value is string temp)
                            this.Checked = temp.ToLower() == bool.TrueString.ToLower(); break;
                    }
                case "color":
                    {
                        if (value is string temp)
                            this.ButtonTintList = ColorStateList.ValueOf(Color.ParseColor(temp.Trim())); break;
                    }
                case "id":
                    {
                        if (value is string temp)
